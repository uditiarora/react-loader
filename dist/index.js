(function (global, factory) {
  ...
  var componentNames = ["BallTriangle", "Bars", "Clock", "Compass", "DancingSquares", "FallingBars", "Flower", "HexagonRipple", "InfinitePlug", "Loading", "MultipleRings", "Rectangles", "Ring", "Ripples", "Simple", "Square", "ThreeDots", "ThreeJumpingDots", "ThreeRings", "Wheel"];

  function componentName(type) {
    if (componentNames.includes(type)) {
      return _loaders2.default[type];
    }
    return _loaders2.default.Simple;
  }
